...
# Define categories (same as in your CNN code)
data_categories = [
...
# Define medicinal properties for each category
...
def predict():
    try:
        ...
        predicted_category = data_categories[predicted_index]
        
        # Get medicinal properties
        medicinal_properties = MEDICINAL_PROPERTIES.get(predicted_category, "No information available.")

        # Return the result
        return jsonify({
            "category": predicted_category,
            "description": medicinal_properties
        })
